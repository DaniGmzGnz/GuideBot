...
You need a telegram bot token. If you don't have one, send a message to [Bot Father](https://t.me/botfather) and follow a few simple steps.
...
Once he enters on the chat (/start), the user has to share its location on real-time.  
...
<img width="295" height="549" src='example-route-4.png'>
</span>
